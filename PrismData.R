# Originally by kelly heilman
# Modified by Lindsay Darling
# Script for averaging and extracting PRISM data to PLS section corners
...
# set the working dir to get corner data
...
#Switch WD to prism data

setwd("D:/Dropbox/Forest Composition/composition/Maps/shapefiles/INILProject/PRISM/PRISM_ppt_stable_4kmM2_189501_198012_bil")
...
t <- crop(s, extent(c(-92.5288, -84.0008 , 35.96194 , 42.9761))) 
